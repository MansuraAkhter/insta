              ...
              <div className="min-w-[600px] bg-white">
                <div className="flex items-center place-content-between bg-white p-4  ">
                  ...
                  <div className="flex">
                    <Button
                      onClick={() => {
                        handleToggleModal(singleData.id);
                      }}
                    >
                ...
                <div className="flex items-center place-content-between bg-white p-4">
                  ...
                  >
                    ...
                    <button
                      style={{ color: "black" }}
                      onClick={() => handleModalOpen(singleData.id)}
                    >
                      <BsChat size={30} />
                    </button>
                    <BsSend size={30} />
                ...
                <div className="px-2 md:px-4 py-3 md:py-6 w-full text-slate-800 ">
                  ...
                  {submittedComments.length > 0 && (
                    <button onClick={() => handleModalOpen(singleData.id)}>
                      view all {submittedComments.length} comments
                    </button>
                  )}
